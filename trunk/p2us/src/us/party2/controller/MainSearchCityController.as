package us.party2.controller
{
	...
	public class MainSearchCityController
	{
		private var _mainSearch:MainSearch;
		private var _searchResults:SearchResults;
		private static var _instance:MainSearchCityController = new MainSearchCityController();
		...
		public function MainSearchCityController()
		{
			
		}
		
		public static function getInstance():MainSearchCityController {
			if (_instance == null) 
				_instance = new MainSearchCityController();
